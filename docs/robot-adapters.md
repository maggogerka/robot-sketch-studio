...
Only `MockRobot` is implemented in v0.3.1. It records deterministic events in memory and powers the browser's visual trajectory simulation. It cannot access serial ports, ROS, G-code devices, or vendor SDKs.
