...
Only `MockRobot` is implemented in v0.2.0. It records deterministic events in memory and powers the browser's visual trajectory simulation. It cannot access serial ports, ROS, G-code devices, or vendor SDKs.
