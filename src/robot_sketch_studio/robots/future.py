...
unimplemented in v0.1.0 so this release cannot move real hardware accidentally.
"""
...
class UnsupportedHardwareAdapter(RobotAdapter):
    def _unsupported(self) -> None:
        raise NotImplementedError("Physical robot control is not available in v0.1.0")
